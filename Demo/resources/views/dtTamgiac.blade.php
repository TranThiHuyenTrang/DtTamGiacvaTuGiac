...
<script src="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.5.0/js/bootstrap.min.js"></script>
    ...
    <form action="" method = "POST" style="margin-left: 400px;margin-top: 200px">
        ...
        @csrf
        <label for="uname"  ><b>Chiều dài đáy tam giác</b></label>
        <input class="form-control" type="text" name="day"style="width: 400px"></input>
        <label for="uname"><b>Chiều cao của tam giác</b></label>
        <input class="form-control" type="text" name="cao"style="width: 400px"></input>
